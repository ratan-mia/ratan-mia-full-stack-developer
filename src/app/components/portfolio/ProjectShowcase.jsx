...
const ProjectShowcase = () => {
  ...
  const PROJECT_DATA = [
    ...
    },
    {
      ...
      description: "Full-stack mobile app for Omoda and Jaecoo Bangladesh featuring test drive booking, service scheduling, an interactive EMI finance calculator with multi-bank rate comparison, digital glovebox, nearby fuel station finder, and a complete dual-brand vehicle ecosystem. Built with React Native and Expo.",
      tech: ["React Native", "Expo", "Supabase", "TypeScript", "Finance Calculator"],
      category: "mobile-app",
      link: "/case-studies/omoda-jaecoo",
      liveUrl: null,
      ...
      duration: "5 months",
      results: ["3K+ Downloads", "600+ Bookings", "4.7★ Rating"],
      metrics: { conversion: "120%", performance: "97%", satisfaction: "94%" },
      featured: true
    },
    {
      id: 3,
