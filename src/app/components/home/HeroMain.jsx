  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <motion.div 
          className="absolute top-1/4 left-1/4 w-72 h-72 md:w-96 md:h-96 bg-blue-500/8 rounded-full blur-3xl"
          animate={{
            x: [0, 100, 0],
            y: [0, -50, 0],
            scale: [1, 1.2, 1],
        ...
        />
        <motion.div 
          className="absolute bottom-1/4 right-1/4 w-80 h-80 md:w-[400px] md:h-[400px] bg-purple-500/8 rounded-full blur-3xl"
          animate={{
            x: [0, -80, 0],
            y: [0, 40, 0],
            scale: [1, 1.3, 1],
        ...
        />
        <motion.div 
          className="absolute top-1/2 right-1/3 w-64 h-64 bg-cyan-500/6 rounded-full blur-2xl"
          animate={{
            y: [0, -60, 0],
            x: [0, 40, 0],
            scale: [1, 1.1, 1],
      ...
      <div className={containerClasses}>
        ...
        <div className={`grid ${compact ? 'grid-cols-1 gap-8' : 'lg:grid-cols-2 gap-12 lg:gap-16'} items-center`}>
          ...
          >
            ...
            <motion.div
              variants={scaleIn}
              className="inline-flex items-center gap-3 bg-gradient-to-r from-green-500/20 to-emerald-500/20 border border-green-400/40 px-6 py-3 rounded-full backdrop-blur-md shadow-xl"
            >
              <motion.div 
            ...
            >
              {statistics.slice(0, compact ? 4 : 4).map((stat, index) => (
                <motion.div 
                  key={stat.label}
                  className="group text-center p-4 bg-white/5 rounded-2xl border border-white/10 backdrop-blur-sm hover:bg-white/10 hover:border-white/20 transition-all duration-300 cursor-pointer"
            ...
            >
              <motion.a
                href="#projects"
                className="group inline-flex items-center justify-center gap-3 px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold text-lg rounded-xl shadow-xl hover:shadow-2xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300"
                whileHover={{ 
                  scale: 1.05, 
                  y: -2,
              ...
              <motion.a
                href="#contact"
                className="group inline-flex items-center justify-center gap-3 px-8 py-4 bg-transparent border-2 border-white/40 text-white font-bold text-lg rounded-xl hover:bg-white hover:text-slate-900 backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-white transition-all duration-300"
                whileHover={{ 
                  scale: 1.05, 
                  y: -2,
              ...
              <motion.a
                href="/resume.pdf"
                download
                className="group inline-flex items-center justify-center gap-3 px-6 py-4 bg-gradient-to-r from-emerald-600 to-green-600 text-white font-semibold text-base rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
                  ...
                  {achievements.map((achievement, index) => (
                    <motion.div
                      ...
                      className={`absolute ${
                        ...
                        '-bottom-6 -right-6'
                      } bg-white/10 backdrop-blur-lg rounded-2xl p-4 border border-white/20 shadow-xl`}
                      initial={{ opacity: 0, scale: 0.8 }}
                      animate={{ opacity: 1, scale: 1 }}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-3xl mx-auto">
              {contactMethods.map((method, index) => (
                <motion.a
                  ...
                  className={`group flex items-center gap-4 p-4 bg-gradient-to-r ${method.color} rounded-xl text-white font-semibold transition-all duration-300 hover:shadow-xl`}
                  whileHover={{ scale: 1.05, y: -2 }}
                  whileTap={{ scale: 0.95 }}
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
