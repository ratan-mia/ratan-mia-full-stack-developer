...
const ProcessHowIWork = () => {
  ...
  const keyMetrics = [
    { metric: "98%", label: "Client Satisfaction", icon: Star, color: "text-amber-500" },
    { metric: "< 2s", label: "Load Time", icon: Zap, color: "text-blue-500" },
    { metric: "95%", label: "On-Time Delivery", icon: Clock, color: "text-emerald-500" },
    { metric: "24/7", label: "Support Available", icon: Shield, color: "text-purple-500" }
  ];

  return (
    <section className="py-20 md:py-32 lg:py-40 px-6 md:px-8 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-900 dark:via-blue-900 dark:to-indigo-900 relative overflow-hidden">
      {/* Enhanced Background Elements */}
      <div className="absolute inset-0 overflow-hidden">
        <motion.div 
          className="absolute top-1/4 right-1/3 w-96 h-96 bg-gradient-to-r from-blue-500/10 to-purple-500/10 dark:from-blue-400/20 dark:to-purple-400/20 rounded-full blur-3xl"
          animate={{
            scale: [1, 1.2, 1],
            rotate: [0, 180, 360],
          }}
        ...
        />
        <motion.div 
          className="absolute bottom-1/4 left-1/3 w-80 h-80 bg-gradient-to-r from-purple-500/10 to-pink-500/10 dark:from-purple-400/20 dark:to-pink-400/20 rounded-full blur-3xl"
          animate={{
            scale: [1, 1.3, 1],
            rotate: [360, 180, 0],
          }}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <motion.div
            ...
            className="inline-flex items-center gap-3 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm text-blue-600 dark:text-blue-400 px-6 py-3 rounded-full font-semibold text-sm tracking-wider uppercase mb-8 shadow-lg border border-blue-200/50 dark:border-blue-800/50"
          >
          ...
          <motion.h2 
            variants={itemVariants}
            className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 text-slate-900 dark:text-white bg-gradient-to-r from-slate-900 to-blue-600 dark:from-white dark:to-blue-400 bg-clip-text"
          >
            How I Work
          </motion.h2>
          ...
          <motion.p 
            variants={itemVariants}
            className="text-lg md:text-xl lg:text-2xl text-slate-600 dark:text-slate-300 max-w-4xl mx-auto leading-relaxed font-light"
          >
        ...
        >
          ...
          <div className="relative">
            ...
            <div className="absolute top-1/2 left-0 right-0 h-2 bg-slate-200 dark:bg-slate-700 rounded-full transform -translate-y-1/2 shadow-inner">
              <motion.div
            ...
            <div className="relative flex justify-between items-center px-4">
              {processSteps.map((step, index) => (
                ...
                >
                  ...
                  <motion.div
                    className={`relative w-16 h-16 lg:w-20 lg:h-20 bg-gradient-to-br ${step.gradient} rounded-2xl lg:rounded-3xl flex items-center justify-center text-white shadow-xl mb-4 ${
                      activeStep === index ? 'ring-4 ring-white shadow-2xl scale-110' : ''
                    } ${hoveredStep === index ? 'shadow-2xl' : ''}`}
                    whileHover={{ y: -4, rotateY: 10 }}
                    transition={{ duration: 0.3 }}
                  >
                    <step.icon className="w-7 h-7 lg:w-9 lg:h-9" />
                    
                    {/* Active pulse animation */}
                    {activeStep === index && (
                      <motion.div
                        className="absolute inset-0 bg-white/20 rounded-2xl lg:rounded-3xl"
                        animate={{ 
                          scale: [1, 1.2, 1], 
                          opacity: [0.5, 0, 0.5] 
                        }}
                    ...
                    {/* Step number */}
                    <div className="absolute -top-2 -right-2 w-6 h-6 bg-white text-slate-900 rounded-full flex items-center justify-center text-xs font-bold shadow-lg">
                      {step.id}
                    </div>
                  </motion.div>
                  ...
                  <div className="text-center max-w-xs lg:max-w-sm">
                    <h3 className="font-bold text-slate-900 dark:text-white text-sm lg:text-base mb-1 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-300">
                      {step.title}
                    </h3>
                    <p className="text-slate-600 dark:text-slate-400 text-xs lg:text-sm leading-relaxed mb-2">
                      {step.subtitle}
                    </p>
                    <motion.div 
                      className="inline-block px-3 py-1 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm text-blue-600 dark:text-blue-400 text-xs font-semibold rounded-full border border-blue-200/50 dark:border-blue-800/50 shadow-sm"
                      whileHover={{ scale: 1.05 }}
                    >
                      {step.duration}
                    </motion.div>
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="mb-16 lg:mb-20"
          >
            <div className={`bg-gradient-to-br ${processSteps[activeStep].bgGradient} backdrop-blur-sm rounded-3xl p-8 lg:p-12 border border-white/50 dark:border-slate-700/50 shadow-2xl`}>
              <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
                {/* Left Column */}
                <div>
                  <div className="flex items-center gap-6 mb-8">
                    <div className={`w-20 h-20 bg-gradient-to-br ${processSteps[activeStep].gradient} rounded-2xl flex items-center justify-center text-white shadow-xl`}>
                      {(() => {
                    ...
                    <div>
                      <h3 className="text-3xl lg:text-4xl font-bold text-slate-900 dark:text-white mb-2">
                      ...
                      <div className="flex items-center gap-4">
                        <span className="px-4 py-2 bg-blue-100 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 text-sm font-semibold rounded-full">
                  ...
                  <div className="space-y-6">
                    <h4 className="font-bold text-slate-900 dark:text-white text-lg uppercase tracking-wider">
                      Key Activities
                    </h4>
                    <div className="space-y-4">
                      {processSteps[activeStep].activities.map((activity, i) => (
                        <motion.div
                          key={i}
                          className="flex items-start gap-4 p-4 bg-white/60 dark:bg-slate-800/60 backdrop-blur-sm rounded-xl border border-white/30 dark:border-slate-700/30"
                ...
                <div className="space-y-8">
                  {/* Deliverables */}
                  <div>
                    <h4 className="font-bold text-slate-900 dark:text-white text-lg uppercase tracking-wider mb-6">
                      Deliverables
                    </h4>
                    <div className="space-y-4">
                      {processSteps[activeStep].deliverables.map((deliverable, i) => (
                        <motion.div
                          key={i}
                          className="flex items-center gap-4 p-4 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-xl border border-white/50 dark:border-slate-700/50 hover:shadow-lg transition-all duration-300"
                  ...
                  {/* Tools & Technologies */}
                  <div>
                    <h4 className="font-bold text-slate-900 dark:text-white text-lg uppercase tracking-wider mb-4">
                      Tools & Technologies
                    </h4>
                    <div className="flex flex-wrap gap-3">
                      {processSteps[activeStep].tools.map((tool, i) => (
                        <span
                          key={i}
                          className="px-4 py-2 bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-300 text-sm font-medium rounded-full border border-slate-200 dark:border-slate-600"
                        >
                          {tool}
                        </span>
                      ))}
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      {Object.entries(processSteps[activeStep].metrics).map(([key, value], i) => (
                        <div key={i} className="text-center p-4 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-xl border border-white/50 dark:border-slate-700/50">
              ...
              {/* Navigation Dots */}
              <div className="flex justify-center gap-3 mt-8 pt-8 border-t border-white/30 dark:border-slate-700/30">
        ...
        >
          <motion.div variants={itemVariants} className="text-center mb-12 lg:mb-16">
            <h3 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 dark:text-white mb-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {methodologies.map((method, index) => (
              <motion.div
                ...
                variants={itemVariants}
                transition={{ delay: index * 0.1 }}
                className={`${method.bgColor} backdrop-blur-sm p-8 rounded-2xl border border-white/50 dark:border-slate-700/50 hover:shadow-2xl transition-all duration-500 text-center group cursor-pointer`}
                whileHover={{ scale: 1.05, y: -8 }}
              >
                <motion.div
                  className={`w-16 h-16 mx-auto mb-6 ${method.color} flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}
                  whileHover={{ rotate: 5 }}
                >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {keyMetrics.map((metric, index) => (
              <motion.div
                ...
                variants={itemVariants}
                transition={{ delay: index * 0.1 }}
                className="text-center p-8 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-2xl border border-white/50 dark:border-slate-700/50 hover:shadow-2xl transition-all duration-500 group"
                whileHover={{ scale: 1.05, y: -6 }}
              >
                <metric.icon className={`w-12 h-12 ${metric.color} mx-auto mb-6 group-hover:scale-110 transition-transform duration-300`} />
                <div className={`text-4xl lg:text-5xl font-bold ${metric.color} mb-4 group-hover:scale-105 transition-transform duration-300`}>
                  {metric.metric}
                </div>
        ...
        >
          <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 rounded-3xl p-12 lg:p-16 text-white shadow-2xl relative overflow-hidden">
