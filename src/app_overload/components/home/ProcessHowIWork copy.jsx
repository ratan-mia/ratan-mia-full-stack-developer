    ...
    <section className="relative py-16 overflow-hidden bg-gray-950">
      ...
      <div className="relative z-10 container mx-auto px-6">
        ...
        >
          ...
          <motion.h2 
            variants={itemVariants}
            className="text-6xl font-bold mb-6 text-white bg-gradient-to-r from-white to-blue-400 bg-clip-text"
          >
            How I Work
          </motion.h2>
              ...
              {processSteps.map((step, index) => (
                ...
                >
                  ...
                  <div className="relative z-10 text-center max-w-sm">
                    <h3 className="font-bold text-white text-base mb-1 group-hover:text-blue-400 transition-colors duration-300">
                      {step.title}
                    </h3>
                    ...
                    <motion.div 
                      className="inline-block px-3 py-1 bg-gradient-to-br from-blue-600/20 to-blue-900/20 border border-blue-800/30 backdrop-blur-sm text-blue-400 text-xs font-medium rounded-full"
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="mb-20"
          >
            <div className="relative bg-gradient-to-b from-gray-900 to-black rounded-2xl p-12 border border-gray-800 shadow-xl">
              {/* Item Glow Effect */}
              ...
              <div className="relative z-10 grid lg:grid-cols-2 gap-12">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                      {processSteps[activeStep].activities.map((activity, i) => (
                        <motion.div
                          key={i}
                          className="flex items-start gap-4 p-4 bg-gray-800 border border-gray-700 rounded-xl hover:bg-gray-700 transition-colors duration-300"
                ...
                <div className="space-y-8">
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      {processSteps[activeStep].deliverables.map((deliverable, i) => (
                        <motion.div
                          key={i}
                          className="flex items-center gap-4 p-4 bg-gray-800 border border-gray-700 rounded-xl hover:bg-gray-700 hover:shadow-lg transition-all duration-300"
                  ...
                  {/* Tools & Technologies */}
                  <div>
                    <h4 className="font-bold text-white text-lg uppercase tracking-wider mb-4">
                      Tools & Technologies
                    </h4>
                    <div className="flex flex-wrap gap-3">
                      {processSteps[activeStep].tools.map((tool, i) => (
                        <span
                          key={i}
                          className="px-4 py-2 bg-gray-800 border border-gray-700 text-gray-300 text-sm font-medium rounded-full hover:bg-gray-700 transition-colors duration-200"
                        >
                          {tool}
                        </span>
                      ))}
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      {Object.entries(processSteps[activeStep].metrics).map(([key, value], i) => (
                        <div key={i} className="text-center p-4 bg-gray-800 border border-gray-700 rounded-xl">
              ...
              {/* Navigation Dots */}
              <div className="flex justify-center gap-3 mt-8 pt-8 border-t border-gray-800">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {methodologies.map((method, index) => (
              ...
              >
                ...
                <h4 className="relative z-10 text-xl font-bold text-white mb-4 group-hover:text-blue-400 transition-colors duration-300">
                  {method.title}
                </h4>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {keyMetrics.map((metric, index) => (
              <motion.div
                ...
                variants={itemVariants}
                transition={{ delay: index * 0.08 }}
                className="group relative cursor-pointer text-center p-8 bg-gradient-to-b from-gray-900 to-black border border-gray-800 group-hover:border-blue-800/50 rounded-2xl hover:shadow-xl transition-all duration-500"
              ...
              >
                ...
                <div className={`relative z-10 text-5xl font-bold ${metric.color} mb-4 group-hover:scale-105 transition-transform duration-300`}>
                  {metric.metric}
                </div>
                <h4 className="relative z-10 text-lg font-bold text-white group-hover:text-blue-400 transition-colors duration-300">
                  {metric.label}
                </h4>
              </motion.div>
            ))}
        ...
        >
          <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 rounded-2xl p-16 text-white shadow-2xl relative overflow-hidden">
