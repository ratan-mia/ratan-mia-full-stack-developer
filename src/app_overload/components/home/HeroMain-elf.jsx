...
const CompactHero = () => {
  ...
  return (
    <motion.section 
      ref={containerRef}
      className="relative min-h-screen flex items-center justify-center bg-gray-950 text-white px-4 sm:px-6 lg:px-8 pt-20 md:pt-24 overflow-hidden"
      style={{ y, opacity }}
    >
      ...
      <div 
        ...
        style={{
          backgroundImage: `url("data:image/svg+xml,%3Csvg width='120' height='120' viewBox='0 0 120 120' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M0 0h120v120H0z' fill='none'/%3E%3Cpath d='M0 20h120M0 40h120M0 60h120M0 80h120M0 100h120M20 0v120M40 0v120M60 0v120M80 0v120M100 0v120' stroke='%23ffffff' stroke-width='0.5' opacity='0.3'/%3E%3Cpath d='M20 20L40 40M40 20L60 40M60 20L80 40M80 20L100 40M100 20L120 40M0 40L20 60M20 40L40 60M40 40L60 60M60 40L80 60M80 40L100 60M100 40L120 60M0 60L20 80M20 60L40 80M40 60L60 80M60 60L80 80M80 60L100 80M100 60L120 80M0 80L20 100M20 80L40 100M40 80L60 100M60 80L80 100M80 80L100 100M100 80L120 100' stroke='%23ffffff' stroke-width='0.3' opacity='0.2'/%3E%3C/svg%3E")`,
      ...
      {/* Racing Circuit Pattern Overlay */}
      <div 
        className="absolute inset-0 opacity-3" 
        style={{
          backgroundImage: `url("data:image/svg+xml,%3Csvg width='200' height='200' viewBox='0 0 200 200' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M50 50h100v100H50z' fill='none' stroke='%23ffffff' stroke-width='1' opacity='0.1'/%3E%3Cpath d='M75 75h50v50H75z' fill='none' stroke='%23ffffff' stroke-width='0.5' opacity='0.1'/%3E%3Cpath d='M100 25v150M25 100h150' stroke='%23ffffff' stroke-width='0.3' opacity='0.05'/%3E%3C/svg%3E")`,
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10 py-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            >
              {keyFeatures.map((feature, index) => (
                <motion.div
                  key={feature.title}
                  className="group relative flex items-center gap-3 p-4 bg-gradient-to-b from-gray-900 to-black border border-gray-800 group-hover:border-blue-800/50 rounded-xl backdrop-blur-sm hover:shadow-xl transition-all duration-300"
                  whileHover={{ scale: 1.02, y: -2 }}
                  transition={{ delay: index * 0.1 }}
                >
                  {/* Item Glow Effect */}
                  <div className="absolute -inset-1 bg-blue-600/0 group-hover:bg-blue-600/10 rounded-xl blur transition-all duration-300"></div>
                  
                  <feature.icon className={`relative z-10 w-5 h-5 ${feature.color} flex-shrink-0`} />
            ...
            >
              {statistics.map((stat, index) => (
                <motion.div 
                  key={stat.label}
                  className="group relative text-center p-4 bg-gradient-to-b from-gray-900 to-black border border-gray-800 group-hover:border-blue-800/50 rounded-xl backdrop-blur-sm hover:shadow-xl transition-all duration-300"
                ...
                >
                  ...
                  <div className={`relative z-10 w-10 h-10 bg-gradient-to-r ${stat.color} rounded-lg flex items-center justify-center mx-auto mb-3`}>
                    <stat.icon className="w-5 h-5 text-white" />
                  </div>
                  <div className={`relative z-10 text-xl md:text-2xl font-bold ${stat.textColor}`}>
                    {stat.number}
                  </div>
                  <div className="relative z-10 text-white text-sm font-semibold">{stat.label}</div>
            ...
            >
              ...
              <motion.a
                href="#contact"
                className="group inline-flex items-center justify-center gap-3 px-8 py-4 bg-transparent border-2 border-gray-700 text-white font-bold text-lg rounded-full hover:border-blue-600 hover:bg-gray-800 transition-all duration-300"
                whileHover={{ scale: 1.05, y: -2 }}
                whileTap={{ scale: 0.95 }}
              >
          ...
          >
            ...
            <div className="relative">
              ...
              >
                {/* Profile Container */}
                <div className="w-full h-full rounded-full bg-gradient-to-b from-gray-900 to-black backdrop-blur-lg border-2 border-gray-800 shadow-2xl overflow-hidden relative">
                  <div className="w-full h-full bg-gradient-to-br from-blue-500/10 via-purple-500/10 to-pink-500/10 flex items-center justify-center relative">
                    ...
                    <div className="absolute inset-0">
                      {coreSkills.slice(0, 8).map((skill, index) => (
                        <motion.div
                          key={skill.name}
                          className="absolute w-10 h-10 bg-gradient-to-b from-gray-800 to-gray-900 border border-gray-700 backdrop-blur-sm rounded-full flex items-center justify-center hover:border-blue-600/50 hover:shadow-lg transition-all duration-300"
                          style={{
                            top: '50%',
                            left: '50%',
                            transformOrigin: '0 0',
                ...
                {[
                  ...
                  <motion.div
                    ...
                    className={`group absolute ${achievement.position} bg-gradient-to-b from-gray-900 to-black backdrop-blur-lg p-4 rounded-xl border border-gray-800 group-hover:border-blue-800/50 shadow-xl hover:shadow-2xl transition-all duration-300`}
        ...
        >
          <motion.a 
            href="#about"
            className="group relative flex items-center gap-4 px-8 py-4 text-white/70 hover:text-white transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-white/30 rounded-full bg-gradient-to-b from-gray-900 to-black border border-gray-800 hover:border-blue-800/50 backdrop-blur-sm hover:shadow-xl"
            whileHover={{ scale: 1.05, y: -3 }}
          >
            {/* Item Glow Effect */}
            <div className="absolute -inset-1 bg-blue-600/0 group-hover:bg-blue-600/10 rounded-full blur transition-all duration-300"></div>
            ...
            <span className="relative text-base font-semibold tracking-wide">Discover My Work</span>
