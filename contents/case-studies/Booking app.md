# TurfNations - Current Features Documentation
...
- **Deep Linking** - `turfnations://bookings` scheme
...
- **Deep Link Routes:**
  ...
  - `turfnations://booking-success` - Payment success
  - `turfnations://booking-failed` - Payment failure
